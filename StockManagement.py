...
def retirar_tv49():
 ...
 if codigo_escaneado in codigo_de_barras_tv49:
   ...
   if note_selecionado in tv49_disponiveis_dicionario:
     ...
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 49\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv22():
 ...
 if codigo_escaneado in codigo_de_barras_tv22:
   ...
   if note_selecionado in tv22_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 22\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv28():
 ...
 if codigo_escaneado in codigo_de_barras_tv28:
   ...
   if note_selecionado in tv28_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 28\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv32():
 ...
 if codigo_escaneado in codigo_de_barras_tv32:
   ...
   if note_selecionado in tv32_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 32\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv55():
 ...
 if codigo_escaneado in codigo_de_barras_tv55:
   ...
   if note_selecionado in tv55_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 55\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv65():
 ...
 if codigo_escaneado in codigo_de_barras_tv65:
   ...
   if note_selecionado in tv65_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 65\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv72():
 ...
 if codigo_escaneado in codigo_de_barras_tv72:
   ...
   if note_selecionado in tv72_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 72\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv75():
 ...
 if codigo_escaneado in codigo_de_barras_tv75:
   ...
   if note_selecionado in tv75_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 75\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv84():
 ...
 if codigo_escaneado in codigo_de_barras_tv84:
   ...
   if note_selecionado in tv84_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 84\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_vw47():
 ...
 if codigo_escaneado in codigo_de_barras_vw47:
   ...
   if note_selecionado in vw47_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou vw 47\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_vw55():
 ...
 if codigo_escaneado in codigo_de_barras_vw55:
   ...
   if note_selecionado in vw55_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou vw 55\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv42():
 ...
 if codigo_escaneado in codigo_de_barras_tv42:
   ...
   if note_selecionado in tv42_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 42\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv43():
 ...
 if codigo_escaneado in codigo_de_barras_tv43:
   ...
   if note_selecionado in tv43_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 43\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
...
def retirar_tv46():
 ...
 if codigo_escaneado in codigo_de_barras_tv46:
   ...
   if note_selecionado in tv46_disponiveis_dicionario:
     ...
     data = 'Retorna: ' + input("Data de retorno:")
     logs = open("logs.txt","a+")
     logs.write("\nID: {} |Retirou TV 46\": {} | para o {} | ás {} |".format(id, note_selecionado, evento, datetime.now(tz)))
     logs.close()
