...
admins = ['carlos@admin', 'rogerio@admin', 'rodrigo@admin']
...
with open('fora_de_uso/controladora_fora_de_uso', 'r') as f:
    fora_de_uso_controladora = json.load(f)
### ↑ Estoque Controladora ↑ ###
...
### ↓ ADMIN MENU ↓ ###
def admin_menu():
  escolha = input("\nO que você gostaria de fazer?\n \n[1] Checar estoque  \n[2] Adicionar equipamento para a lista de \"FORA DE USO\" [3] Adicionar equipamento ao estoque \nPleno: ")
  if escolha == "1":
    cls()
